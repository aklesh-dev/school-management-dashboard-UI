...
const LoginPage = () => {
  ...
  return (
    <div className="h-screen flex items-center justify-center bg-izumiSkyLight">
      <SignIn.Root>
        <SignIn.Step
          name="start"
        ...
        >
          ...
          <SignIn.Action submit className="bg-blue-500 p-[10px] text-white my-1 rounded-md">Sign In</SignIn.Action>
        </SignIn.Step>
      </SignIn.Root>
    </div>
  );
